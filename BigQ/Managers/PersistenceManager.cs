...
namespace BigQ
{
    ...
    public class PersistenceManager
    {
        ...
        /// <param name="config">Server configuration instance.</param>
        ...
        private string EncodeHeaders(Dictionary<string, string> headers)
        {
            ...
            return Convert.ToBase64String(Encoding.UTF8.GetBytes(Helper.SerializeJson(headers)));
        }
        ...
        private Dictionary<string, string> DecodeHeaders(string headers)
        {
            ...
            return Helper.DeserializeJson<Dictionary<string, string>>(Convert.FromBase64String(headers));
        }

        private string EncodeData(byte[] data)
        {
            if (data == null || data.Length < 1) return null;
            return Helper.BytesToHex(data); 
        }
